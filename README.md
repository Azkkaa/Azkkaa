...
* 🥇 **The Best Overall** – Campus Technical Competition for **"RuangSense"**, an IoT-based environmental monitoring system (Temperature, Humidity, & Gas detection).
...
### 🚀 Future & Ongoing Ambitious Projects
- [ ] **Autonomous Drone Navigation System:** Developing an advanced flight & guidance network using MicroPython on ESP32 hardware.
